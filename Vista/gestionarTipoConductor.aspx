<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestionarTipoConductor.aspx.cs" Inherits="Vistalcgs.gestionarTipoConductor" %>
...
<body>
    ...
    <div class="container">
        <br />
        <h1>Gestión Tipo Conductores</h1>
        <br />
        <form id="form1" runat="server">
            ...
            <div class="form-group">
               <label for="txtTipoPersona">tipo de persona</label>
                    ...
                    <th>
                        <asp:GridView ID="GridView" runat="server" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:BoundField DataField="id_tipo_conductor" HeaderText="id_tipo_conductor" />                                                          
                            </Columns>
                        </asp:GridView>
                    </th>
                </tr>
