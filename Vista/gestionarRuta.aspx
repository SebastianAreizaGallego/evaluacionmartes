<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestionarRuta.aspx.cs" Inherits="Vistalcgs.gestionarRuta" %>
...
<body>
    ...
    <div class="container">
        ...
        <form id="form1" runat="server">
            ...
            <div class="form-group">
               <label for="txtEstacion">Estación</label>
                <asp:TextBox ID="txtEstacion" runat="server" Class="form-control"></asp:TextBox>
            </div>

            <div class="form-group">
               <label for="txtIdVehiculo">Id Vehículo</label>
